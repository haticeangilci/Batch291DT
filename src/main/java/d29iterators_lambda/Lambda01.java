...
public class Lambda01 {
    ...
    public static void printElements2(List<Integer> nums) {
        nums.stream().forEach(t -> System.out.print(t + " ")); // t -> akistan gelen her bir t degeri icin //12 9 131 14 9 10 4 12 15
    }
    //--------------------------
    ...
    //Example 3:Find all even numbers in a List<Integer> and write a method that prints
    // these numbers to the console on the same line, with a space between them.(Structured)
